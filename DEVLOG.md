...
![Bedside Table and Glowstone Lamp in a bedroom](docs/images/example_room_w_bedsidetable.png)
...
The latest additions have not been deeply tested yet.
...
- Flint Pebbles generate on the surface and around exposed underground sediment
- Breaking a Flint Pebble returns one Flint
- Flint Pickaxes and Axes replace their wooden equivalents
- Flint tools use the same statistics as the former wooden tools
...
- Sheep drop Raw Mutton instead of Wool when killed
- Burning sheep drop Cooked Mutton
- Raw Mutton can be cooked in a Furnace
